...
#1. FASTQ files from Juliano lab in /data/wraycompute/malaria/vivax/DRC/
R1=\${ACC}_R1_001.fastq.gz
R2=\${ACC}_R2_001.fastq.gz
...
rm -rf \${ACC}.bam \${ACC}.bam.bai #delete pre-deduped bam files here to save space
...
#DO NOT delete fastq files for DRC samples!!!!!!! they were not downloaded from SRA database!
